namespace MVCWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static v客戶分析Repository Getv客戶分析Repository()
		{
			var repository = new v客戶分析Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static v客戶分析Repository Getv客戶分析Repository(IUnitOfWork unitOfWork)
		{
			var repository = new v客戶分析Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
